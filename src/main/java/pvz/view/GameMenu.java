...
import pvz.model.entities.zombies.ArmorType;
...
public class GameMenu implements AppMenu {
    ...
    private pvz.controller.menu.GameMenuController controller;

    @Override
    public void check(Scanner scanner) {
        if (controller == null) controller = new pvz.controller.menu.GameMenuController(pvz.model.App.getInstance());
