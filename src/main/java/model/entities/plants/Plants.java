...
public enum Plants {
    ...
    SUNFLOWER("Sunflower", PlantsCategory.SUN_PRODUCER,
            new ArrayList<>(Collections.singletonList(PlantTag.DAY)), 50, 300, 0, 24, 5),
    TWIN_SUNFLOWER("Twin Sunflower", PlantsCategory.SUN_PRODUCER,
            new ArrayList<>(Collections.singletonList(PlantTag.DAY)), 125, 300, 0, 24, 15),
    ...
    PEASHOOTER("Peashooter", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.PEA)), 100, 300, 20, 1.5, 5),
    REPEATER("Repeater", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.PEA)), 200, 300, 20, 1.5, 5),
    THREEPEATER("Threepeater", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.PEA)), 300, 300, 20, 1.5, 5),
    ...
    SPLIT_PEA("Split Pea", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.PEA)), 125, 300, 20, 1.5, 5),
    CITRON("Citron", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.CHARGE)), 350, 300, 800, 9, 5),
    BOWLING_BULB("Bowling Bulb", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.CHARGE)), 200, 300, 40, 2, 5),
    ...
    GOO_PEASHOOTER("Goo Peashooter", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.POISON)), 125, 300, 20, 1.5, 5),
    MEGA_GATLING_PEA("Mega Gatling Pea", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.PEA)), 400, 300, 20, 1.5, 5),
    ...
    PUFF_SHROOM("Puff-shroom", PlantsCategory.SHOOTER,
            new ArrayList<>(Collections.singletonList(PlantTag.SHROOM)), 0, 300, 20, 1.5, 5),
    ...
    ELECTRIC_BLUEBERRY("Electric Blueberry", PlantsCategory.HOMING,
            new ArrayList<>(Collections.singletonList(PlantTag.CHARGE)), 150, 300, 5000, 12, 15),
    ...
    FUME_SHROOM("Fume-shroom", PlantsCategory.STRIKE_THROUGH,
            new ArrayList<>(Collections.singletonList(PlantTag.SHROOM)), 125, 300, 20, 1.5, 5),
    ...
    MELON_PULT("Melon-pult", PlantsCategory.LOBBER,
            new ArrayList<>(Collections.singletonList(PlantTag.AOE)), 325, 300, 80, 2.9, 5),
    ...
    SQUASH("Squash", PlantsCategory.EXPLOSIVE,
            new ArrayList<>(Collections.singletonList(PlantTag.TRAP)), 50, 300, 1800, 0, 20),
    GRAPESHOT("Grapeshot", PlantsCategory.EXPLOSIVE,
            new ArrayList<>(), 150, 0, 1800, 0, 35),
    JALAPENO("Jalapeno", PlantsCategory.EXPLOSIVE,
            new ArrayList<>(Collections.singletonList(PlantTag.FIRE)), 125, 0, 1800, 0, 35),
    DOOM_SHROOM("Doom-shroom", PlantsCategory.EXPLOSIVE,
            new ArrayList<>(Collections.singletonList(PlantTag.SHROOM)), 125, 0, 1800, 0, 15),
    ...
    HOT_POTATO("Hot Potato", PlantsCategory.EXPLOSIVE,
            new ArrayList<>(Collections.singletonList(PlantTag.FIRE)), 0, 0, 0, 0, 5),
    ...
    PHAT_BEET("Phat Beet", PlantsCategory.MELEE,
            new ArrayList<>(Collections.singletonList(PlantTag.AOE)), 150, 300, 15, 2, 5),
    CHOMPER("Chomper", PlantsCategory.MELEE,
            new ArrayList<>(), 150, 300, 9999, 40, 5),
    WASABI_WHIP("Wasabi Whip", PlantsCategory.MELEE,
            new ArrayList<>(Collections.singletonList(PlantTag.FIRE)), 150, 300, 40, 2, 5),
    ...
    GARLIC("Garlic", PlantsCategory.WALL_NUT,
            new ArrayList<>(Collections.singletonList(PlantTag.MOVE_ZOMBIES)), 50, 300, 0, 0, 20),
    SWEET_POTATO("Sweet Potato", PlantsCategory.WALL_NUT,
            new ArrayList<>(Collections.singletonList(PlantTag.MOVE_ZOMBIES)), 150, 3000, 0, 0, 20),
    EXPLODE_O_NUT("Explode-o-nut", PlantsCategory.WALL_NUT,
            new ArrayList<>(Collections.singletonList(PlantTag.EXPLOSIVE)), 50, 4000, 1800, 0, 20),
    PUMPKIN("Pumpkin", PlantsCategory.WALL_NUT,
            new ArrayList<>(Collections.singletonList(PlantTag.STACK)), 150, 4000, 0, 0, 20),
    SUN_BEAN("Sun Bean", PlantsCategory.WALL_NUT,
            new ArrayList<>(Collections.singletonList(PlantTag.SUN)), 50, 1000, 0, 0, 20),

    TORCHWOOD("Torchwood", PlantsCategory.MODIFIER,
            new ArrayList<>(Collections.singletonList(PlantTag.FIRE)), 175, 300, 0, 0, 5),
    ...
    public ArrayList<PlantTag> getTags() {
        return tags;
    }
